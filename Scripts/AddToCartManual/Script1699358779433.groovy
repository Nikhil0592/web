...
WebUI.setText(findTestObject('Object Repository/EcommLandingPageObjects/input_KART_search-keyword'), 'cauliflower')
...
WebUI.click(findTestObject('Object Repository/EcommLandingPageObjects/p_Cauliflower - 1 Kg'))
